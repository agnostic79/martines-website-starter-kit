            ...
            for (var M, z, P, k = i.slidesPerColumn, L = T / k, $ = Math.floor(c / i.slidesPerColumn), I = 0; I < c; I += 1) {
              ...
              if ("none" !== O.css("display")) {
                ...
                p[I] && (p[I].swiperSlideSize = S),
                  v.push(S),
                  i.centeredSlides
                    ? ((y = y + S / 2 + E / 2 + w), 0 === E && 0 !== I && (y = y - r / 2 - w), 0 === I && (y = y - r / 2 - w), Math.abs(y) < 0.001 && (y = 0), i.roundLengths && (y = Math.floor(y)), x % i.slidesPerGroup == 0 && u.push(y), h.push(y))
    ...
    J = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            (e.params.loop
              ? ((i = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > s - 1 - 2 * e.loopedSlides && (i -= s - 2 * e.loopedSlides), i > n - 1 && (i -= n), i < 0 && "bullets" !== e.params.paginationType && (i = n + i))
    ...
    te = {
      ...
      onTouchStart: function (e) {
        ...
        i.$imageEl &&
          0 !== i.$imageEl.length &&
          (s.isTouched ||
            (t.android && e.cancelable && e.preventDefault(), (s.isTouched = !0), (s.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX), (s.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)));
      },
